...
var Home = class _Home {
  ...
  ngOnInit() {
    fetch(this.platformLocation.getBaseHrefFromDOM() + "sessions").then((res) => res.json()).then((json) => {
      console.log(json);
    }).catch((error) => {
      console.log(error);
    });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Home, { className: "Home", filePath: "src/app/pages/home/home.ts", lineNumber: 11 });
})();
export {
  Home
};
//# sourceMappingURL=chunk-UTHLPQ7F.js.map

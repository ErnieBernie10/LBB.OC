...
public class GetSessionsQueryHandler(LbbDbContext context) : IQueryHandler<GetSessionsQuery, IEnumerable<GetSessionsResponseDto>>
{
    public async Task<IEnumerable<GetSessionsResponseDto>> HandleAsync(GetSessionsQuery query, CancellationToken cancellationToken = default)
    {
